...
from ShirokoRobot import telethn, BOT_USERNAME, SUPPORT_CHAT
...
BUTTON = [[
    Button.url(F"【► HELP ◄】", f"https://t.me/{BOT_USERNAME}?start=help"),
...
async def hmm(yes):
    ...
    pm_caption = f"** ♡ Hey [{yes.sender.first_name}](tg://user?id={yes.sender.id}) I,m Shiroko 愛 **\n\n"
