...
from ShirokoRobot import SHIROKO_PTB, DEV_USERS
...
SHIROKO_PTB.add_handler(CommandHandler("addnsfw", add_nsfw, block=False))
SHIROKO_PTB.add_handler(CommandHandler("rmnsfw", rem_nsfw, block=False))
SHIROKO_PTB.add_handler(
    CommandHandler("nsfwchats",
                   list_nsfw_chats,
                   filters=filters.User(DEV_USERS),
                   block=False))
SHIROKO_PTB.add_handler(CommandHandler("lewdkemo", lewdkemo, block=False))
SHIROKO_PTB.add_handler(CommandHandler("neko", neko, block=False))
SHIROKO_PTB.add_handler(CommandHandler("feet", feet, block=False))
SHIROKO_PTB.add_handler(CommandHandler("yuri", yuri, block=False))
SHIROKO_PTB.add_handler(CommandHandler("trap", trap, block=False))
SHIROKO_PTB.add_handler(CommandHandler("futanari", futanari, block=False))
SHIROKO_PTB.add_handler(CommandHandler("hololewd", hololewd, block=False))
SHIROKO_PTB.add_handler(CommandHandler("sologif", sologif, block=False))
SHIROKO_PTB.add_handler(CommandHandler("cumgif", cumgif, block=False))
SHIROKO_PTB.add_handler(CommandHandler("erokemo", erokemo, block=False))
SHIROKO_PTB.add_handler(CommandHandler("lesbian", lesbian, block=False))
SHIROKO_PTB.add_handler(CommandHandler("wallpaper", wallpaper, block=False))
SHIROKO_PTB.add_handler(CommandHandler("lewdk", lewdk, block=False))
SHIROKO_PTB.add_handler(CommandHandler("ngif", ngif, block=False))
SHIROKO_PTB.add_handler(CommandHandler("tickle", tickle, block=False))
SHIROKO_PTB.add_handler(CommandHandler("lewd", lewd, block=False))
SHIROKO_PTB.add_handler(CommandHandler("feed", feed, block=False))
SHIROKO_PTB.add_handler(CommandHandler("eroyuri", eroyuri, block=False))
SHIROKO_PTB.add_handler(CommandHandler("eron", eron, block=False))
SHIROKO_PTB.add_handler(CommandHandler("cum", cum, block=False))
SHIROKO_PTB.add_handler(CommandHandler("bjgif", bjgif, block=False))
SHIROKO_PTB.add_handler(CommandHandler("bj", bj, block=False))
SHIROKO_PTB.add_handler(CommandHandler("nekonsfw", nekonsfw, block=False))
SHIROKO_PTB.add_handler(CommandHandler("solo", solo, block=False))
SHIROKO_PTB.add_handler(CommandHandler("kemonomimi", kemonomimi, block=False))
SHIROKO_PTB.add_handler(CommandHandler("avatarlewd", avatarlewd, block=False))
SHIROKO_PTB.add_handler(CommandHandler("gasm", gasm, block=False))
SHIROKO_PTB.add_handler(CommandHandler("poke", poke, block=False))
SHIROKO_PTB.add_handler(CommandHandler("anal", anal, block=False))
SHIROKO_PTB.add_handler(CommandHandler("hentai", hentai, block=False))
SHIROKO_PTB.add_handler(CommandHandler("avatar", avatar, block=False))
SHIROKO_PTB.add_handler(CommandHandler("erofeet", erofeet, block=False))
SHIROKO_PTB.add_handler(CommandHandler("holo", holo, block=False))
SHIROKO_PTB.add_handler(CommandHandler("tits", tits, block=False))
SHIROKO_PTB.add_handler(CommandHandler("pussygif", pussygif, block=False))
SHIROKO_PTB.add_handler(CommandHandler("holoero", holoero, block=False))
SHIROKO_PTB.add_handler(CommandHandler("pussy", pussy, block=False))
SHIROKO_PTB.add_handler(CommandHandler("hentaigif", hentaigif, block=False))
SHIROKO_PTB.add_handler(CommandHandler("classic", classic, block=False))
SHIROKO_PTB.add_handler(CommandHandler("kuni", kuni, block=False))
SHIROKO_PTB.add_handler(CommandHandler("waifu", waifu, block=False))
SHIROKO_PTB.add_handler(CommandHandler("lewd", lewd, block=False))
SHIROKO_PTB.add_handler(CommandHandler("kiss", kiss, block=False))
SHIROKO_PTB.add_handler(CommandHandler("femdom", femdom, block=False))
SHIROKO_PTB.add_handler(CommandHandler("cuddle", cuddle, block=False))
SHIROKO_PTB.add_handler(CommandHandler("hug", hug, block=False))
SHIROKO_PTB.add_handler(CommandHandler("erok", erok, block=False))
SHIROKO_PTB.add_handler(CommandHandler("foxgirl", foxgirl, block=False))
SHIROKO_PTB.add_handler(CommandHandler("titsgif", titsgif, block=False))
SHIROKO_PTB.add_handler(CommandHandler("ero", ero, block=False))
SHIROKO_PTB.add_handler(CommandHandler("smug", smug, block=False))
SHIROKO_PTB.add_handler(CommandHandler("baka", baka, block=False))
